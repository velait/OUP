data {
  ...
  real empirical_stat_var[2];
  real empirical_length_scale[2];
}
...
transformed data {
  ...
  real length_scale_a = square(empirical_length_scale[1])/(empirical_length_scale[2] + 1);
  real length_scale_b = empirical_length_scale[1]/(empirical_length_scale[2] + 1);
  
  real stat_var_a = square(empirical_stat_var[1])/(empirical_stat_var[2]);
  real stat_var_b = empirical_stat_var[1]/(empirical_stat_var[2]);
...
model {
  ...
  for(s in 1:N_series) {
    ...
    for(t in 2:N_times) {
      ...
      Y[s, t] ~ normal(transition_mean, sqrt(transition_var) + epsilon);
  ...
  stat_var ~ normal(stat_var_a, stat_var_b);
